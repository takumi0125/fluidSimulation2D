config =
  default:
    siteUrl: 'https://takumi0125.github.io/fluidSimulation2D/displacement/'
    keywords: 'webgl, threejs, fluid simulation 2D'

    showOGP: true # ogpタグを表示するかどうか

    siteTitle: 'displacement by fluid | fluid simulation 2D'
    useTitleAsOgTitle: true # ogTitleをtitleと同じにするかどうか
    ogTitle: ''
    useTitleSeparater: true
    titleSeparater: ' | '

    description: "displacement by fluid"
    useDescriptionAsOgDescription: true # ogDescriptionをdescriptionと同じにするかどうか
    ogDescription: ""

    ogSiteName: 'displacement by fluid | fluid simulation 2D'

    ogImage: 'https://takumi0125.github.io/fluidSimulation2D/assets/img/ogpDisplacement.png'
