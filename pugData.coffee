config =
  default:
    siteUrl: 'https://takumi0125.github.io/fluidSimulation2D/mix/'
    keywords: 'webgl, threejs, fluid simulation 2D'

    showOGP: true # ogpタグを表示するかどうか

    siteTitle: 'mix fluid | fluid simulation 2D'
    ...
    ogSiteName: 'mix fluid | fluid simulation 2D'

    ogImage: 'https://takumi0125.github.io/fluidSimulation2D/assets/img/ogpMix.png'
